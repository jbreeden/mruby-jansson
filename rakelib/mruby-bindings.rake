...
namespace :bindings do
  ...
  task :scrape do
    ...
    headers = ['jansson-2.7/src/jansson.h']
    ...
    headers.each do |header|
      sh "clang2json -I jansson-2.7/src #{header} >> declarations.json"
    end
  end
  ...
  task :'enable-functions' do
    sh 'mrbind enable-functions -m Jansson -g mruby-jansson -o .'
  end
  
  task :fn_count do
    sh "cat include/mruby_Jansson_functions.h | egrep 'TRUE|FALSE' | wc -l"
  end

  task :bound_fns do
    sh "cat include/mruby_Jansson_functions.h | egrep 'TRUE'"
  end

  task :bound_fn_count do
    sh "cat include/mruby_Jansson_functions.h | egrep 'TRUE' | wc -l"
  end

  task :unbound_fns do
    sh "cat include/mruby_Jansson_functions.h | egrep 'FALSE'"
  end

  task :unbound_fn_count do
    sh "cat include/mruby_Jansson_functions.h | egrep 'FALSE' | wc -l"
  end
end
